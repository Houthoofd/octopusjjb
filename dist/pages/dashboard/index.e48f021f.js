        ...
        if (panelRow) {
            ...
            try {
                ...
                if (Object.keys(userInfo).length === 0) participantsDiv.textContent = "Aucune information trouv\xe9e.";
                    ...
                    form.appendChild(createInputField("Pr\xe9nom", "first_name", userInfo.first_name));
                    ...
                    form.appendChild(createInputField("R\xf4le", "role", userInfo.role, true)); // Champ désactivé
                    ...
                    const enableFormFields = (enable)=>{
                        form.querySelectorAll("input").forEach((input)=>{
                            if (input.name !== "role") input.disabled = !enable;
                        });
                    };
        ...
        >
          ...
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
               ${(0, _core.asyncAppend)(dashboard.preloadData(), (result)=>{
                return (0, _core.html)`
                    ${(0, _core.repeat)(result, (0, _core.html)`${(user)=>{
                    console.log(user);
                    return (0, _core.html)`
...
let template = (0, _core.html)`${(context)=>{
    return (0, _core.html)`<page-dashboard></page-dashboard>`;
}}`;
(0, _core.render)(template);

},{"@swc/helpers/_/_ts_decorate":"lX6TJ","@lithium-framework/core":"hmv1B","@lithium-framework/router-element":"cZ2Eg","unofficial-pf-v5-wc":"eGY4R","unofficial-pf-v5-wc-icons":"gk8FK","../../components":"HH6XE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jdvue","cfbDU"], "cfbDU", "parcelRequirec605")
