        ...
        <footer>
            ...
            <div class="footer-bottom">
                ...
                <a href="#"><img src="twitter-icon.png" alt="Twitter"></a>
                    ...
                    `,n.append(o,a,r,l,d,c),s.appendChild(n),n.addEventListener("click",e=>{let t=document.querySelector("pf-modal")||document.createElement("pf-modal"),s=e.currentTarget,n=i.querySelector('input[name="name"]'),o=i.querySelector('input[name="mail"]');console.log(n,o);let a=n?n.value:"Nom non fourni",r=o?o.value:"Email non fourni";t.classList.toggle("active");let l=s.querySelector(".date-infos")?.innerHTML||"Date non disponible",d=s.querySelector(".heure-debut-infos")?.innerHTML||"Heure de début non disponible",c=s.querySelector(".heure-fin-infos")?.innerHTML||"Heure de fin non disponible",u=s.querySelector(".type-de-cours-infos")?.innerHTML||"Type de cours non disponible",v=`
...
//# sourceMappingURL=index.ce38f7fe.js.map
