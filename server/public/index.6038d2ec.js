var s=globalThis,i={},e={},t=s.parcelRequirec605;null==t&&((t=function(s){if(s in i)return i[s].exports;if(s in e){var t=e[s];delete e[s];var a={id:s,exports:{}};return i[s]=a,t.call(a.exports,a,a.exports),a.exports}var r=Error("Cannot find module '"+s+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(s,i){e[s]=i},s.parcelRequirec605=t),t.register;var a=t("1BF7I");t("lTDtW"),t("5OQrz"),t("2LYUy");let r=(0,a.html)`${s=>(s.createConsumable("selection",[]),localStorage.getItem("first_name")&&console.log(localStorage.getItem("first_name")||""),(0,a.html)`<div class='home'>
        ...
        <section id="réservation">
            ...
            <pf-button primary @click=${i=>{console.log("Bouton cliqué :",i.currentTarget),console.log("Contexte :",s)}}>Cliquez-ici</pf-button>
            <form>
                <div>
                ...
                <pf-modal class='result-box' scrollable medium>
                    ...
                    <slot>
                        <div>
                            ${(0,a.asyncAppend)(o,s=>(console.log(s),(0,a.html)`
                                <div>
                                    <p>Cours trouvés : ${s.length}</p>
                                    <ul>
                                        ${(0,a.repeat)(s,(0,a.html)`${s=>(0,a.html)`<li>
                                                        <p><strong>Type de cours:</strong> ${s.type_cours}</p>
                                                        <p><strong>Date:</strong></p>
                                                        <p><strong>Heure de début:</strong> ${s.heure_debut}</p>
                                                        <p><strong>Heure de fin:</strong> ${s.heure_fin}</p>
                                                    </li>`}`)}
                                    </ul>
                                </div>
                                `))}
    ...
    </div>`)}`;const o=new Promise((s,i)=>{fetch("http://localhost:3000/cours/",{method:"GET",headers:{"Content-Type":"application/json"}}).then(s=>{if(!s.ok)throw i("Erreur serveur."),Error("Erreur serveur.");return s.json()}).then(i=>{i.length>0?(console.log("Réponse du serveur:",i),s(i)):s([])}).catch(s=>{console.error("Erreur lors de la requête fetch:",s),i(s)})});(0,a.render)(r);
//# sourceMappingURL=index.6038d2ec.js.map
