var i=globalThis,s={},e={},t=i.parcelRequirec605;null==t&&((t=function(i){if(i in s)return s[i].exports;if(i in e){var t=e[i];delete e[i];var a={id:i,exports:{}};return s[i]=a,t.call(a.exports,a,a.exports),a.exports}var l=Error("Cannot find module '"+i+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(i,s){e[i]=s},i.parcelRequirec605=t),t.register;var a=t("1BF7I");t("lTDtW"),t("5OQrz"),t("2LYUy");let l=(0,a.html)`${i=>(i.createConsumable("selection",[]),localStorage.getItem("first_name")&&console.log(localStorage.getItem("first_name")||""),(0,a.html)`<div class='home'>
                    ...
                    <slot>
                        <div class="table-infos">
                            ${(0,a.asyncAppend)(r,i=>(0,a.html)`
                                <div class="raw-infos">
                                        ${(0,a.repeat)(i,(0,a.html)`${i=>(0,a.html)`<div class="row" @click=${i=>{console.log(o(i.date_cours))}}>
    ...
    </div>`)}`;const r=new Promise((i,s)=>{fetch("http://localhost:3000/cours/",{method:"GET",headers:{"Content-Type":"application/json"}}).then(i=>{if(!i.ok)throw s("Erreur serveur."),Error("Erreur serveur.");return i.json()}).then(s=>{s.length>0?(console.log("Réponse du serveur:",s),i(s)):i([])}).catch(i=>{console.error("Erreur lors de la requête fetch:",i),s(i)})});function o(i){let s=new Date(i),e=s.getFullYear(),t=String(s.getMonth()+1).padStart(2,"0"),a=String(s.getDate()).padStart(2,"0");return`${e}-${t}-${a}`}(0,a.render)(l);
//# sourceMappingURL=index.904054fe.js.map
