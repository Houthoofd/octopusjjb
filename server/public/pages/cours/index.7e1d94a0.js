          ...
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
              ${(0,n.asyncAppend)(e.preloadData(),r=>(0,n.html)`${(0,n.repeat)(r,(0,n.html)`${r=>(console.log(r),(0,n.html)`
                          <div class="row">
                            <div class="type-de-cours">${e.formatDateFromISO(r.date_cours)}</div>
                            <div class="heure-debut">${r.heure_debut}</div>
                            <div class="heure-fin">${r.heure_fin}</div>
                            <div class="type-de-cours">${r.type_cours}</div>
                            <pf-button @click="${e=>r.register(e)}" primary>inscription</pf-button>
                          </div>`)}`)}`)}
            </div>
          </pf-panel>
        <pf-avatar></pf-avatar>
...
//# sourceMappingURL=index.7e1d94a0.js.map
