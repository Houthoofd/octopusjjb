                    ...
                    ${(0,i.repeat)(r.cours,(0,i.html)`${r=>(console.log(r.participants),(0,i.html)`
                          <div class="panel-row">
                            <div class="row">
                              ...
                              ${!0===e.isAdmin?(0,i.html)``:(0,i.html)`<div @click="${()=>e.displayParticipants(r)}" class='icon-down'><div class='icon'><pf-icons-chevron-down></pf-icons-chevron-down></div></div>`}
                            </div>
...
//# sourceMappingURL=index.6955ce3d.js.map
