              ...
              ${(0,n.asyncAppend)(e.preloadData(),t=>(console.log(t),(0,n.html)`
                    ${(0,n.repeat)(t,(0,n.html)`${t=>(console.log(t),(0,n.html)`
                          <div class="row">
                            ...
                            ${!0===e.isAdmin?(0,n.html)`<div class='icon-down'><div class='icon'><pf-icons-chevron-down></pf-icons-chevron-down></div></div>`:(0,n.html)``}
                          </div>`)}`)}`))}
            </div>
          </pf-panel>
          <pf-avatar></pf-avatar>
...
//# sourceMappingURL=index.9e6ac607.js.map
