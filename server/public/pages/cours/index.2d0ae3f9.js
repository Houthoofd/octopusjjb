                    ...
                    ${(0,n.repeat)(t,(0,n.html)`${t=>(console.log(t),(0,n.html)`
                        <div class="panel-info">
                          <div class="row">
                            ...
                            ${!0===e.isAdmin?(0,n.html)`<div @click="${()=>e.loadDataParticipants(t)}" class='icon-down'><div class='icon'><pf-icons-chevron-down></pf-icons-chevron-down></div></div>`:(0,n.html)``}
                          </div>
                          <div class="participants">
                            ${(0,n.asyncAppend)(e.displayParticipants(t),e=>(0,n.html)`${(0,n.repeat)(e,(0,n.html)`${e=>(0,n.html)`<div class="row-participant-info">
...
//# sourceMappingURL=index.2d0ae3f9.js.map
