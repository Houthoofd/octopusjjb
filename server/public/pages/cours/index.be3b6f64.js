          ...
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
              ${(0,n.asyncAppend)(e.preloadData(),t=>(0,n.html)`
                    ${(0,n.repeat)(t.cours,(0,n.html)`${t=>(console.log(t.participants),(0,n.html)`
                          <div class="panel-row">
                            <div class="row">
                            ...
                            <div class="participants">
                              ${(0,n.asyncAppend)(e.preloadData(),e=>(0,n.html)`${(0,n.repeat)(e.cours.participants,(0,n.html)`${e=>(console.log(e),(0,n.html)`
...
//# sourceMappingURL=index.be3b6f64.js.map
