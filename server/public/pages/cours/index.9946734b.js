          ...
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
              ${(0,n.asyncAppend)(e.preloadData(),t=>(0,n.html)`
                    ${(0,n.repeat)(t.cours,(0,n.html)`${r=>(console.log(r),(0,n.html)`
                          <div class="panel-row">
                            <div class="row">
                              ...
                              ${!0===e.isAdmin?(0,n.html)`<div @click="${()=>e.displayParticipants(r)}" class='icon-down'><div class='icon'><pf-icons-chevron-down></pf-icons-chevron-down></div></div>`:(0,n.html)``}
                            </div>
                            <div class="participants">
                              ${(0,n.repeat)(t.cours.participants,(0,n.html)`${e=>(console.log(e),(0,n.html)`
...
//# sourceMappingURL=index.9946734b.js.map
