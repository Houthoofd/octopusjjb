var e=globalThis,t={},r={},o=e.parcelRequirec605;null==o&&((o=function(e){if(e in t)return t[e].exports;if(e in r){var o=r[e];delete r[e];var a={id:e,exports:{}};return t[e]=a,o.call(a.exports,a,a.exports),a.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){r[e]=t},e.parcelRequirec605=o),o.register;var a=o("7WQrb"),i=o("5D1XK");o("RKbfs"),o("5OQrz"),o("2LYUy"),o("7KTRf");class n extends i.WebComponent{connectedCallback(){super.connectedCallback(),this.getRole()}async register(e){}async preloadData(){try{let e=await fetch("http://localhost:3000/cours/",{method:"GET",headers:{"Content-Type":"application/json"}});if(!e.ok)throw Error("Erreur serveur.");let t=await e.json();return t.cours.length>0?t:[]}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}getRole(){let e=localStorage.getItem("userData");if(!e)throw Error("Utilisateur non connecté. Aucune donnée dans localStorage.");let t=JSON.parse(e);console.log("Données utilisateur récupérées:",t);let r=t.role;console.log("Rôle de l'utilisateur:",r),"administrator"===r||"super-administrator"===r?this.isAdmin=!0:this.isAdmin=!1,console.log("Est-ce un administrateur ? ",this.isAdmin)}async loadParticipants(e){console.log(e.id);try{let t=await fetch("http://localhost:3000/cours/inscription",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({cour_id:e.id})});if(!t.ok)throw Error("Erreur serveur.");let r=await t.json();return r.cours.length>0?r:[]}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}displayParticipants(e){console.log(e.id);let t=this.shadowRoot?.querySelector(".panel-row");if(t){t.classList.toggle("active"),console.log('Classe "active" togglée pour:',t);let r=document.createElement("div");r.classList.add("new-participants"),r.textContent="Nouvelle div ajoutée",console.log(this.loadParticipants(e.id)),t.appendChild(r),console.log("Nouvelle div ajoutée:",r)}else console.error('Aucun élément "panel-row" trouvé.')}formatDateFromISO(e){let t=new Date(e),r=t.getFullYear(),o=String(t.getMonth()+1).padStart(2,"0"),a=String(t.getDate()).padStart(2,"0");return`${r}-${o}-${a}`}convertToISODate(e){let[t,r,o]=e.split("-");return new Date(`${t}-${r}-${o}T00:00:00Z`).toISOString()}constructor(...e){super(...e),this.data=[],this.isAdmin=null}}(0,a.__decorate)([(0,i.state)()],n.prototype,"isAdmin",void 0),n=(0,a.__decorate)([(0,i.customElement)({name:"page-cours",template:(0,i.html)`${e=>(0,i.html)`
        <pf-page
          masterhead-no-icon
      ...
      `]})],n);let l=(0,i.html)`${e=>(0,i.html)`<page-cours></page-cours>`}`;(0,i.render)(l);
//# sourceMappingURL=index.c41a5ee4.js.map
