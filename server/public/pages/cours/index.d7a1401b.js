                    ...
                    ${(0,n.repeat)(t,(0,n.html)`${t=>(console.log(t),(0,n.html)`
                        <div class="panel-info">
                          ...
                          <div class="participants">
                            ${(0,n.asyncAppend)(e.displayParticipants(t),e=>(0,n.html)`
                                ${(0,n.repeat)(e,(0,n.html)`${e=>(0,n.html)`
                                      <div class="row-info-participant">
                                        <div class="last_name">${e.first_name}</div>
                                        <div class="first_name">${e.last_name}</div>
                                      </div>`}`)}
                              `)}
                          </div>
                        </div>`)}`)}`))}
...
//# sourceMappingURL=index.d7a1401b.js.map
