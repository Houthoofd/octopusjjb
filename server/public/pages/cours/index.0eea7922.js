        ...
        >
          ...
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
              ${(0,s.asyncAppend)(e.preloadData(),r=>(0,s.html)`
                    ${(0,s.repeat)(r.cours,(0,s.html)`${r=>(console.log(r.participants),(0,s.html)`
                          <div class="panel-row">
                            <div class="row">
                              ...
                              ${!0===e.isAdmin?(0,s.html)`<div @click="${()=>e.displayParticipants(r)}" class='icon-down'><div class='icon'><pf-icons-chevron-down></pf-icons-chevron-down></div></div>`:(0,s.html)``}
                            </div>
                            <div class="participants">
                              ${(0,s.repeat)(r.participants,(0,s.html)`${e=>(0,s.html)`
                                    <div class="pill">
...
//# sourceMappingURL=index.0eea7922.js.map
