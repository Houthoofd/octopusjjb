        ...
        <div class="main-body">
          ...
          <div class='input-field'>
            <input type="text" placeholder="Nom" 
              @input="${o=>{e.handleLastNameInput()}}" 
              required>
          </div>

          
          <button class="button-register" type="submit" 
            @click="${o=>{e.handleSubmit()}}"
...
//# sourceMappingURL=index.3a7de131.js.map
