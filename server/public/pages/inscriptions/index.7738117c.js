        ...
        <div class="main-body">
          ...
          <div class='input-field'>
            <input type="email" placeholder="Email" 
              ...
              value="${e.email||""}">
            <div class="info">
              ${e.isEmailValid?(0,r.html)`<div class="valide"><pf-icons-check-circle></pf-icons-check-circle></div>`:(0,r.html)`<span>Votre adresse email doit contenir le caractère '@'</span>`}
            </div>
          </div>
...
//# sourceMappingURL=index.7738117c.js.map
