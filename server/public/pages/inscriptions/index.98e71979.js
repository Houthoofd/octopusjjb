var e=globalThis,i={},o={},s=e.parcelRequirec605;null==s&&((s=function(e){if(e in i)return i[e].exports;if(e in o){var s=o[e];delete o[e];var a={id:e,exports:{}};return i[e]=a,s.call(a.exports,a,a.exports),a.exports}var t=Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}).register=function(e,i){o[e]=i},e.parcelRequirec605=s);var a=s.register;a("7KTRf",function(e,i){s("lnjTs"),s("6D2jc"),s("eUTkO"),s("3T3Tr"),s("jcBBX"),s("augsA"),s("4cMYp"),s("hmMWw"),s("3d3pD"),s("3Bkhj")}),a("lnjTs",function(e,i){s("augsA")}),a("augsA",function(e,i){var o=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("5OQrz"),s("2LYUy");class t extends a.WebComponent{attributeChangedCallback(e,i,o){super.attributeChangedCallback(e,i,o)}handleEmailInput(e){let i=this.shadowRoot?.querySelectorAll("input"),o=i?.[0].value||"";this.Mail=o,this.validateForm()}handlePasswordInput(e){let i=this.shadowRoot?.querySelectorAll("input"),o=i?.[1].value||"";console.log(o),this.Password=o,this.validateForm()}validateForm(){console.log(this.Mail,this.Password),this.isFormValid=""!==this.Mail&&""!==this.Password,this.errorMessage=this.isFormValid?null:"Veuillez entrer à la fois un email et un mot de passe."}async sendData(){if(this.isFormValid){let e={email:this.Mail,password:this.Password};console.log(e);try{let i=await fetch("http://localhost:3000/connexion",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(i.ok){let e=await i.json();console.log("Connexion réussie",e),console.log(e);let o={nom:e.userData.last_name,prenom:e.userData.first_name,email:e.userData.email,role:e.userData.role,cours:e.userData.cours||[]};localStorage.setItem("userData",JSON.stringify(o)),window.location.href="/pages/cours"}else console.error("Erreur lors de la connexion :",i.statusText),this.errorMessage="Échec de la connexion. Veuillez vérifier vos informations."}catch(e){console.error("Erreur lors de la requête :",e),this.errorMessage="Une erreur est survenue. Veuillez réessayer plus tard."}}else this.errorMessage="Veuillez remplir tous les champs."}handleLogin(){this.validateForm(),this.isFormValid&&this.sendData()}toggleRememberMe(){this.rememberMe=!this.rememberMe}constructor(...e){super(...e),this.email="",this.password="",this.rememberMe=!1,this.isFormValid=!1,this.errorMessage=null,this.isCustom=!1,this.Mail="",this.Password=""}}(0,o.__decorate)([(0,a.state)()],t.prototype,"email",void 0),(0,o.__decorate)([(0,a.state)()],t.prototype,"password",void 0),(0,o.__decorate)([(0,a.state)()],t.prototype,"rememberMe",void 0),(0,o.__decorate)([(0,a.state)()],t.prototype,"isFormValid",void 0),(0,o.__decorate)([(0,a.state)()],t.prototype,"errorMessage",void 0),(0,o.__decorate)([(0,a.state)()],t.prototype,"isCustom",void 0),(0,o.__decorate)([(0,a.customElement)({name:"login-page",template:(0,a.html)`${e=>(0,a.html)`
      <div class="login">
        <div class="header">
    ...
    `],shadowOptions:{mode:"open"}})],t)}),a("eUTkO",function(e,i){s("hmMWw")}),a("hmMWw",function(e,i){var o=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("5OQrz"),s("2LYUy");class t extends a.WebComponent{}(0,o.__decorate)([(0,a.customElement)({name:"new-password-page",template:(0,a.html)`${e=>(0,a.html)`
        <div class="login">
          <div class="header">
    ...
    `],shadowOptions:{mode:"open"}})],t)}),a("3T3Tr",function(e,i){s("3d3pD")}),a("3d3pD",function(e,i){var o=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("5OQrz"),s("2LYUy");class t extends a.WebComponent{attributeChangedCallback(e,i,o){"custom"===e&&(this.isCustom="true"===o),"info"===e&&(this.isInfo="true"===o),"success"===e&&(this.isSuccess="true"===o),"warning"===e&&(this.isWarning="true"===o),"danger"===e&&(this.isDanger="true"===o),super.attributeChangedCallback(e,i,o)}constructor(...e){super(...e),this.custom=null,this.info=null,this.success=null,this.warning=null,this.danger=null,this.isCustom=!1,this.isInfo=!1,this.isSuccess=!1,this.isWarning=!1,this.isDanger=!1}}(0,o.__decorate)([(0,a.attr)()],t.prototype,"custom",void 0),(0,o.__decorate)([(0,a.attr)()],t.prototype,"info",void 0),(0,o.__decorate)([(0,a.attr)()],t.prototype,"success",void 0),(0,o.__decorate)([(0,a.attr)()],t.prototype,"warning",void 0),(0,o.__decorate)([(0,a.attr)()],t.prototype,"danger",void 0),(0,o.__decorate)([(0,a.state)()],t.prototype,"isCustom",void 0),(0,o.__decorate)([(0,a.state)()],t.prototype,"isInfo",void 0),(0,o.__decorate)([(0,a.state)()],t.prototype,"isSuccess",void 0),(0,o.__decorate)([(0,a.state)()],t.prototype,"isWarning",void 0),(0,o.__decorate)([(0,a.state)()],t.prototype,"isDanger",void 0),(0,o.__decorate)([(0,a.customElement)({name:"notification-box",template:(0,a.html)`${e=>(0,a.html)`
    ...
    `],shadowOptions:{mode:"open"}})],t)}),a("jcBBX",function(e,i){s("3Bkhj")}),a("3Bkhj",function(e,i){var o=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("5OQrz"),s("2LYUy");class t extends a.WebComponent{}(0,o.__decorate)([(0,a.customElement)({name:"navigation-panel",template:(0,a.html)`${e=>(0,a.html)`
    ...
    `]})],t)});
//# sourceMappingURL=index.98e71979.js.map
