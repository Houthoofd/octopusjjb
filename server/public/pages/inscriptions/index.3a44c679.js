    ...
    `],shadowOptions:{mode:"open"}})],a)}),s("6D2jc",function(e,t){o("4cMYp")}),s("4cMYp",function(e,t){var i=o("7WQrb"),s=o("5D1XK");o("RKbfs"),o("5OQrz"),o("2LYUy");class a extends s.WebComponent{handleEmailInput(e){let t=e.target;this.email=t.value,this.isEmailValid=this.email.includes("@"),this.checkFormValidity()}handlePasswordInput(e){let t=e.target;this.password=t.value,this.isPasswordValid=this.password.length>=6,this.updatePasswordStrength(),this.checkFormValidity()}handleConfirmPasswordInput(e){let t=e.target;this.confirmPassword=t.value,this.doPasswordsMatch=this.password===this.confirmPassword,this.checkFormValidity()}handleFirstNameInput(e){let t=e.target;this.firstName=t.value,this.checkFormValidity()}handleLastNameInput(e){let t=e.target;this.lastName=t.value,this.checkFormValidity()}handleDateInput(e){let t=e.target;this.birthDate=t.value,this.checkFormValidity()}updatePasswordStrength(){let e=0;this.password.length>=6&&(e+=20),/[A-Z]/.test(this.password)&&(e+=20),/[0-9]/.test(this.password)&&(e+=20),/[^A-Za-z0-9]/.test(this.password)&&(e+=20),this.password.length>=10&&(e+=20),this.passwordStrength=e}checkFormValidity(){this.isFormValid=this.isEmailValid&&this.isPasswordValid&&this.doPasswordsMatch&&""!==this.firstName&&""!==this.lastName&&""!==this.birthDate}handleSubmit(){this.isFormValid&&console.log("Form submitted",{email:this.email,password:this.password,firstName:this.firstName,lastName:this.lastName,birthDate:this.birthDate})}constructor(...e){super(...e),this.isEmailValid=!0,this.isPasswordValid=!0,this.doPasswordsMatch=!0,this.isFormValid=!1,this.passwordStrength=0,this.email="",this.password="",this.confirmPassword="",this.firstName="",this.lastName="",this.birthDate=""}}(0,i.__decorate)([(0,s.state)()],a.prototype,"isEmailValid",void 0),(0,i.__decorate)([(0,s.state)()],a.prototype,"isPasswordValid",void 0),(0,i.__decorate)([(0,s.state)()],a.prototype,"doPasswordsMatch",void 0),(0,i.__decorate)([(0,s.state)()],a.prototype,"isFormValid",void 0),(0,i.__decorate)([(0,s.state)()],a.prototype,"passwordStrength",void 0),(0,i.__decorate)([(0,s.customElement)({name:"inscription-page",template:(0,s.html)`${e=>(0,s.html)`
      <div class="register">
        ...
        <div class="main-body">
          ...
          <!-- Password input avec jauge de force -->
          <div class='input-field'>
            ...
            ${e.isPasswordValid?"":(0,s.html)`<p class="error">Password must be at least 6 characters long</p>`}
          </div>
...
//# sourceMappingURL=index.3a44c679.js.map
