      ...
      <div class="${["notification",e.isCustom?"-custom":"",e.isInfo?"-info":"",e.isSuccess?"-success":"",e.isWarning?"-warning":"",e.isDanger?"-danger":""].join("")}">
        ...
        <div class="main-body">
          ...
          <div class="infos">
            <div class="title">
              ${e.isCustom?(0,n.html)`<pf-icons-bell></pf-icons-bell>`:""}
              ${e.isInfo?(0,n.html)`<p>Information</p>`:""}
              ${e.isSuccess?(0,n.html)`<p>Success</p>`:""}
              ${e.isWarning?(0,n.html)`<p>Warning</p>`:""}
              ${e.isDanger?(0,n.html)`<p>Danger</p>`:""}
            </div>
...
//# sourceMappingURL=index.8faf4ebb.js.map
