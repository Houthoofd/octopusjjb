var e=globalThis,t={},r={},a=e.parcelRequirec605;null==a&&((a=function(e){if(e in t)return t[e].exports;if(e in r){var a=r[e];delete r[e];var n={id:e,exports:{}};return t[e]=n,a.call(n.exports,n,n.exports),n.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){r[e]=t},e.parcelRequirec605=a),a.register;var n=a("7WQrb"),o=a("5D1XK");a("RKbfs"),a("5OQrz"),a("2LYUy"),a("7KTRf");class s extends o.WebComponent{async preloadData(){try{let e=await fetch("http://localhost:3000/users/",{method:"GET",headers:{"Content-Type":"application/json"}});if(!e.ok)throw Error("Erreur serveur.");let t=await e.json();return console.log(t),t.length>0?t:[]}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}async loadInfosUser(e){console.log(e);try{let t=await fetch("http://localhost:3000/users/infos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({user_id:e})});if(!t.ok)throw Error("Erreur serveur.");let r=await t.json();return console.log(r),r.length>0?r:[]}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}async displayMoreInfos(e){console.log("User ID:",e.id);let t=this.shadowRoot?.querySelector(`.panel-row[data-user-id="${e.id}"]`);if(console.log(t),t){if(t.classList.contains("active")){t.classList.remove("active"),console.log("Panel désactivé.");return}t.classList.add("active"),console.log("Panel activé:",t);let r=t.querySelector(".new-participants");if(r&&r.children.length>0){console.log("Participants déjà chargés. Aucun rechargement nécessaire.");return}r||((r=document.createElement("div")).classList.add("new-participants"),t.appendChild(r));try{let t=await this.loadInfosUser(e.id);console.log(t),r.innerHTML="",0===Object.keys(t).length?r.textContent="Aucun participant trouvé.":Object.values(t).forEach(e=>{let t=document.createElement("div");t.classList.add("pill");let a=document.createElement("div");a.classList.add("first-name"),a.textContent=e.first_name;let n=document.createElement("div");n.classList.add("last-name"),n.textContent=e.last_name,t.appendChild(a),t.appendChild(n),r.appendChild(t)})}catch(e){console.error("Erreur lors du chargement des participants:",e),r.textContent="Erreur lors du chargement des participants."}console.log("Participants ajoutés dans la div:",r)}else console.error('Aucun élément "panel-row" trouvé pour ce cours.')}}s=(0,n.__decorate)([(0,o.customElement)({name:"page-dashboard",template:(0,o.html)`${e=>(0,o.html)`
        <pf-page
          masterhead-no-icon
...
//# sourceMappingURL=index.51926d10.js.map
