          ...
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
               ${(0,o.asyncAppend)(e.preloadData(),t=>(0,o.html)`
                    ${(0,o.repeat)(t,(0,o.html)`${t=>(console.log(!0===e.isSuperAdmin),(0,o.html)`
                          <div class="panel-row" data-user-id="${t.id}">
                            <div class="row">
                              ...
                              ${(()=>{let t=JSON.parse(localStorage.getItem("userData"));return t?.role==="super-administrator"?(0,o.html)`
    <div @click="${t=>e.deleteUser(t)}">Test</div>
  `:(0,o.html)``})()}
                            </div>
                          </div>`)}`)}`)}
            </div>
...
//# sourceMappingURL=index.a76a4a9b.js.map
