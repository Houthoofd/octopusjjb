                    ...
                    ${(0,o.repeat)(t,(0,o.html)`${t=>(console.log(t),(0,o.html)`
                          <div class="panel-row" data-user-id="${t.id}">
                            <div class="row">
                              ...
                              <div @click="${t=>e.deleteUser(t)}" class='icon-down'><div class='icon'><pf-icons-trash-alt></pf-icons-trash-alt></div></div>
                              ${!0===navigation.isAdmin?(0,o.html)`<div class="item"><a href="/pages/dashboard">dashboard</a></div>`:(0,o.html)``}
                            </div>
                          </div>`)}`)}`)}
            </div>
          </pf-panel>
...
//# sourceMappingURL=index.061dc828.js.map
