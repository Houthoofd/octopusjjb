var e=globalThis,t={},a={},n=e.parcelRequirec605;null==n&&((n=function(e){if(e in t)return t[e].exports;if(e in a){var n=a[e];delete a[e];var o={id:e,exports:{}};return t[e]=o,n.call(o.exports,o,o.exports),o.exports}var r=Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,t){a[e]=t},e.parcelRequirec605=n),n.register;var o=n("7WQrb"),r=n("5D1XK");n("RKbfs"),n("5OQrz"),n("2LYUy"),n("7KTRf");class l extends r.WebComponent{async preloadData(){try{let e=await fetch("http://localhost:3000/users/",{method:"GET",headers:{"Content-Type":"application/json"}});if(!e.ok)throw Error("Erreur serveur.");let t=await e.json();return console.log(t),t.length>0?t:[]}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}async loadInfosUser(e){console.log(e);try{let t=await fetch("http://localhost:3000/users/infos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({user_id:e})});if(!t.ok)throw Error("Erreur serveur.");let a=await t.json();return console.log(a),a}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}async displayMoreInfos(e){console.log("User ID:",e.id);let t=this.shadowRoot?.querySelector(`.panel-row[data-user-id="${e.id}"]`);if(console.log(t),t){if(t.classList.contains("active")){t.classList.remove("active"),console.log("Panel désactivé.");return}t.classList.add("active"),console.log("Panel activé:",t);let a=t.querySelector(".new-participants");if(a||((a=document.createElement("div")).classList.add("new-participants"),t.appendChild(a)),a.children.length>0){console.log("Informations déjà chargées. Aucun rechargement nécessaire.");return}try{let t=await this.loadInfosUser(e.id);if(console.log(t),a.innerHTML="",0===Object.keys(t).length)a.textContent="Aucune information trouvée.";else{let e=document.createElement("form");e.classList.add("user-info-form");let n=(e,t,a,n=!1)=>{let o=document.createElement("div");o.classList.add("form-group");let r=document.createElement("label");r.textContent=e;let l=document.createElement("input");return l.type="text",l.name=t,l.value=a||"",l.disabled=n,l.classList.add("form-control"),o.appendChild(r),o.appendChild(l),o};e.appendChild(n("Prénom","first_name",t.first_name)),e.appendChild(n("Nom","last_name",t.last_name)),e.appendChild(n("Email","email",t.email)),e.appendChild(n("Rôle","role",t.role,!0)),e.appendChild(n("Genre","gender",t.gender)),e.appendChild(n("Date de naissance","date_of_birth",new Date(t.date_of_birth).toLocaleDateString())),e.appendChild(n("Grade","grade",t.grade));let o=document.createElement("button");o.type="button",o.textContent="Modifier les informations",o.classList.add("edit-btn");let r=document.createElement("button");r.type="button",r.textContent="Présences",r.classList.add("more-infos-btn");let l=document.createElement("button");l.type="button",l.textContent="Sauvegarder",l.classList.add("save-btn"),l.style.display="none",e.appendChild(o),e.appendChild(l),a.appendChild(e),a.appendChild(r);let s=t=>{e.querySelectorAll("input").forEach(e=>{"role"!==e.name&&(e.disabled=!t)})};o.addEventListener("click",()=>{s(!0),l.style.display="block",o.style.display="none"}),r.addEventListener("click",()=>{console.log("more infos");let e={email:t.email,prenom:t.first_name,nom:t.last_name};console.log(e);let a=new URLSearchParams(e).toString();if(console.log("queryString"+a),e.email&&e.prenom&&e.nom)fetch("http://localhost:1234/pages/profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t.email,prenom:t.first_name,nom:t.last_name})}).then(e=>e.json()).then(e=>{console.log("Statistiques de l'admin:",e)}).catch(e=>console.error("Erreur:",e));else{let e=localStorage.getItem("email"),t=localStorage.getItem("firstName"),a=localStorage.getItem("lastName");console.log("fetch via body"),fetch("http://localhost:1234/pages/profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,firstName:t,lastName:a})}).then(e=>e.json()).then(e=>{console.log("Statistiques de l'admin:",e)}).catch(e=>console.error("Erreur:",e))}}),l.addEventListener("click",async()=>{let t={first_name:e.first_name.value,last_name:e.last_name.value,email:e.email.value,gender:e.gender.value,date_of_birth:e.date_of_birth.value,grade:e.grade.value};try{console.log("Informations mises à jour avec succès:",t),s(!1),l.style.display="none",o.style.display="block"}catch(e){console.error("Erreur lors de la mise à jour des informations:",e)}})}}catch(e){console.error("Erreur lors du chargement des informations :",e),a.textContent="Erreur lors du chargement des informations."}console.log("Informations ajoutées dans la div:",a)}else console.error('Aucun élément "panel-row" trouvé pour cet utilisateur.')}}l=(0,o.__decorate)([(0,r.customElement)({name:"page-dashboard",template:(0,r.html)`${e=>(0,r.html)`
        <pf-page
          masterhead-no-icon
          ...
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
               ${(0,r.asyncAppend)(e.preloadData(),t=>(0,r.html)`
                    ${(0,r.repeat)(t,(0,r.html)`${t=>(console.log(t),(0,r.html)`
      ...
      `]})],l);let s=(0,r.html)`${e=>(0,r.html)`<page-dashboard></page-dashboard>`}`;(0,r.render)(s);
//# sourceMappingURL=index.e6c6515a.js.map
