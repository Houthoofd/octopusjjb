                          ...
                          <div class="row">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  ${(0,n.asyncAppend)(e.preloadDataDropDown("http://localhost:3000/informations/grade"),t=>(0,n.html)`${(0,n.repeat)(t,(0,n.html)`${t=>(console.log(t),(0,n.html)`<div class="dropdown-item" data-plan="${t.grade}"@click="${t=>e.handleDropDownValueGrade(t)}">
                                         ${t.grade}
                                        </div>`)}`)}`)}
                                </div>
                              </details>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <!-- Les éléments du menu seront ajoutés ici -->
                                  ${(0,n.asyncAppend)(e.preloadDataDropDown("http://localhost:3000/informations/abonnement"),t=>(0,n.html)`${(0,n.repeat)(t,(0,n.html)`${t=>(0,n.html)`<div class="dropdown-item" data-plan="${t.nom_plan}" data-prix="${t.prix}" @click="${t=>e.handleDropDownValueTarif(t)}">
                                         ${t.nom_plan} - ${t.prix} €
                                        </div>`}`)}`)}
                                </div>
                              </details>
...
//# sourceMappingURL=index.e8af5b77.js.map
