var e=globalThis,i={},o={},t=e.parcelRequirec605;null==t&&((t=function(e){if(e in i)return i[e].exports;if(e in o){var t=o[e];delete o[e];var a={id:e,exports:{}};return i[e]=a,t.call(a.exports,a,a.exports),a.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,i){o[e]=i},e.parcelRequirec605=t);var a=t.register;a("7KTRf",function(e,i){t("lnjTs"),t("6D2jc"),t("eUTkO"),t("3T3Tr"),t("jcBBX"),t("augsA"),t("4cMYp"),t("hmMWw"),t("3d3pD"),t("3Bkhj")}),a("lnjTs",function(e,i){t("augsA")}),a("augsA",function(e,i){var o=t("7WQrb"),a=t("5D1XK");t("RKbfs"),t("5OQrz"),t("2LYUy");class s extends a.WebComponent{attributeChangedCallback(e,i,o){super.attributeChangedCallback(e,i,o)}handleEmailInput(e){let i=this.shadowRoot?.querySelectorAll("input"),o=i?.[0].value||"";this.Mail=o,this.validateForm()}handlePasswordInput(e){let i=this.shadowRoot?.querySelectorAll("input"),o=i?.[1].value||"";console.log(o),this.Password=o,this.validateForm()}validateForm(){console.log(this.Mail,this.Password),this.isFormValid=""!==this.Mail&&""!==this.Password,this.errorMessage=this.isFormValid?null:"Veuillez entrer à la fois un email et un mot de passe."}async sendData(){if(this.isFormValid){let e={email:this.Mail,password:this.Password};console.log(e);try{let i=await fetch("http://localhost:3000/connexion",{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify(e)});if(i.ok){let e=await i.json();console.log("Connexion réussie",e),console.log(e);let o={nom:e.userData.nom,prenom:e.userData.prenom,email:e.userData.email,role:e.userData.role};localStorage.setItem("userData",JSON.stringify(o)),e.token?(console.log("Token JWT:",e.token),localStorage.setItem("token",e.token)):console.error("Erreur de connexion"),window.location.href="/pages/cours"}else console.error("Erreur lors de la connexion :",i.statusText),this.errorMessage="Échec de la connexion. Veuillez vérifier vos informations."}catch(e){console.error("Erreur lors de la requête :",e),this.errorMessage="Une erreur est survenue. Veuillez réessayer plus tard."}}else this.errorMessage="Veuillez remplir tous les champs."}handleLogin(){this.validateForm(),this.isFormValid&&this.sendData()}toggleRememberMe(){this.rememberMe=!this.rememberMe}constructor(...e){super(...e),this.email="",this.password="",this.rememberMe=!1,this.isFormValid=!1,this.errorMessage=null,this.isCustom=!1,this.Mail="",this.Password=""}}(0,o.__decorate)([(0,a.state)()],s.prototype,"email",void 0),(0,o.__decorate)([(0,a.state)()],s.prototype,"password",void 0),(0,o.__decorate)([(0,a.state)()],s.prototype,"rememberMe",void 0),(0,o.__decorate)([(0,a.state)()],s.prototype,"isFormValid",void 0),(0,o.__decorate)([(0,a.state)()],s.prototype,"errorMessage",void 0),(0,o.__decorate)([(0,a.state)()],s.prototype,"isCustom",void 0),(0,o.__decorate)([(0,a.customElement)({name:"login-page",template:(0,a.html)`${e=>(0,a.html)`
      <div class="login">
        <div class="header">
      ...
      <div class="register">
        ...
        <div class="main-body">
          ...
          <div class='dropdown-choice-price'>
            <pf-dropdown-menu>
              ${(0,a.asyncAppend)(e.preloadData(),e=>(0,a.html)`${(0,a.repeat)(e,(0,a.html)`${e=>(0,a.html)`<pf-dropdown-menu-item>${e.nom_plan}" "${e.prix}</pf-dropdown-menu-item>`}`)}`)}
            </pf-dropdown-menu>
          </div>
    ...
    `],shadowOptions:{mode:"open"}})],s)}),a("eUTkO",function(e,i){t("hmMWw")}),a("hmMWw",function(e,i){var o=t("7WQrb"),a=t("5D1XK");t("RKbfs"),t("5OQrz"),t("2LYUy");class s extends a.WebComponent{}(0,o.__decorate)([(0,a.customElement)({name:"new-password-page",template:(0,a.html)`${e=>(0,a.html)`
        <div class="login">
          <div class="header">
    ...
    `],shadowOptions:{mode:"open"}})],s)}),a("3T3Tr",function(e,i){t("3d3pD")}),a("3d3pD",function(e,i){var o=t("7WQrb"),a=t("5D1XK");t("RKbfs"),t("5OQrz"),t("2LYUy");class s extends a.WebComponent{attributeChangedCallback(e,i,o){"custom"===e&&(this.isCustom="true"===o),"info"===e&&(this.isInfo="true"===o),"success"===e&&(this.isSuccess="true"===o),"warning"===e&&(this.isWarning="true"===o),"danger"===e&&(this.isDanger="true"===o),super.attributeChangedCallback(e,i,o)}constructor(...e){super(...e),this.custom=null,this.info=null,this.success=null,this.warning=null,this.danger=null,this.isCustom=!1,this.isInfo=!1,this.isSuccess=!1,this.isWarning=!1,this.isDanger=!1}}(0,o.__decorate)([(0,a.attr)()],s.prototype,"custom",void 0),(0,o.__decorate)([(0,a.attr)()],s.prototype,"info",void 0),(0,o.__decorate)([(0,a.attr)()],s.prototype,"success",void 0),(0,o.__decorate)([(0,a.attr)()],s.prototype,"warning",void 0),(0,o.__decorate)([(0,a.attr)()],s.prototype,"danger",void 0),(0,o.__decorate)([(0,a.state)()],s.prototype,"isCustom",void 0),(0,o.__decorate)([(0,a.state)()],s.prototype,"isInfo",void 0),(0,o.__decorate)([(0,a.state)()],s.prototype,"isSuccess",void 0),(0,o.__decorate)([(0,a.state)()],s.prototype,"isWarning",void 0),(0,o.__decorate)([(0,a.state)()],s.prototype,"isDanger",void 0),(0,o.__decorate)([(0,a.customElement)({name:"notification-box",template:(0,a.html)`${e=>(0,a.html)`
    ...
    `],shadowOptions:{mode:"open"}})],s)}),a("jcBBX",function(e,i){t("3Bkhj")}),a("3Bkhj",function(e,i){var o=t("7WQrb"),a=t("5D1XK");t("RKbfs"),t("5OQrz"),t("2LYUy");class s extends a.WebComponent{connectedCallback(){super.connectedCallback(),this.getRole()}getRole(){let e=localStorage.getItem("userData");if(!e)throw Error("Utilisateur non connecté. Aucune donnée dans localStorage.");let i=JSON.parse(e);console.log("Données utilisateur récupérées:",i);let o=i.role;console.log("Rôle de l'utilisateur:",o),"administrator"===o||"super-administrator"===o?this.isAdmin=!0:this.isAdmin=!1,console.log("Est-ce un administrateur ? ",this.isAdmin)}constructor(...e){super(...e),this.isAdmin=null}}(0,o.__decorate)([(0,a.state)()],s.prototype,"isAdmin",void 0),(0,o.__decorate)([(0,a.customElement)({name:"navigation-panel",template:(0,a.html)`${e=>(0,a.html)`
    ...
    `]})],s)});
//# sourceMappingURL=index.91b1f10c.js.map
