var e=globalThis,t={},o={},a=e.parcelRequirec605;null==a&&((a=function(e){if(e in t)return t[e].exports;if(e in o){var a=o[e];delete o[e];var r={id:e,exports:{}};return t[e]=r,a.call(r.exports,r,r.exports),r.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){o[e]=t},e.parcelRequirec605=a),a.register;var r=a("7WQrb"),n=a("5D1XK");a("RKbfs"),a("3I5Zu"),a("dLLJA"),a("7KTRf");class l extends n.WebComponent{connectedCallback(){super.connectedCallback(),this.getRole()}checkUserConnection(){return!!localStorage.getItem("userData")||(window.location.href="/pages/connexion",!1)}getRole(){if(!this.checkUserConnection())return;let e=JSON.parse(localStorage.getItem("userData"));console.log("Données utilisateur récupérées:",e);let t=e.role;console.log("Rôle de l'utilisateur:",t),"administrator"===t||"super-administrator"===t?this.isAdmin=!0:this.isAdmin=!1,console.log("Est-ce un administrateur ? ",this.isAdmin)}async preloadData(e){try{let e=localStorage.getItem("userData");if(!e)throw Error("Utilisateur non connecté. Aucune donnée dans localStorage.");let t=JSON.parse(e);console.log("Données utilisateur récupérées:",t);let o=await fetch("http://www.octopusjjb.ovh/informations",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!o.ok)throw Error("Erreur serveur.");let a=[await o.json()];return console.log("Données mises dans un tableau:",a,a.length),a.length>0?a:[]}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}async preloadDataDropDown(e){try{let t=await fetch(e,{method:"GET",headers:{"Content-Type":"application/json"}});if(!t.ok)throw Error("Erreur serveur.");let o=await t.json();return console.log(o,o.length),o.length>0?o:[]}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}enableEditing(e){return console.log("Enable editing"),this.shadowRoot.getElementById("first_name").removeAttribute("readonly"),this.shadowRoot.getElementById("last_name").removeAttribute("readonly"),this.shadowRoot.getElementById("email").removeAttribute("readonly"),this.shadowRoot.getElementById("edit-button").style.display="none",this.shadowRoot.getElementById("save-button").style.display="inline-block",(0,n.html)`<div>Vous pouvez modifier désormais</div>`}validateForm(){let e=this.shadowRoot?.getElementById("email").value,t=this.shadowRoot?.getElementById("first_name").value,o=this.shadowRoot?.getElementById("last_name").value;return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)?!!t&&!!o||(alert("Tous les champs doivent être remplis"),!1):(alert("Veuillez entrer un email valide"),!1)}async saveChanges(){if(this.validateForm()){let e=this.shadowRoot?.getElementById("email").value,t=this.shadowRoot?.getElementById("first_name").value,o=this.shadowRoot?.getElementById("last_name").value,a=localStorage.getItem("userData"),r=a?JSON.parse(a):{};fetch("http://www.octopusjjb.ovh/users/update",{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({new_email:e,new_first_name:t,new_last_name:o,current_mail:r.email,current_first_name:r.prenom,current_last_name:r.nom})}).then(e=>e.json()).then(e=>{e.success?(alert("Modifications enregistrées avec succès"),localStorage.setItem("userData",JSON.stringify(e.data))):alert("Erreur lors de l'enregistrement")}).catch(e=>{console.error("Erreur:",e),alert("Une erreur s'est produite lors de la tentative d'enregistrement")}),this.shadowRoot.getElementById("first_name").setAttribute("readonly","true"),this.shadowRoot.getElementById("last_name").setAttribute("readonly","true"),this.shadowRoot.getElementById("email").setAttribute("readonly","true"),this.shadowRoot.getElementById("save-button").style.display="none",this.shadowRoot.getElementById("edit-button").style.display="inline-block"}}formatDateFromISO(e){let t=new Date(e),o=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0");return`${o}-${a}-${r}`}convertToISODate(e){let[t,o,a]=e.split("-");return new Date(`${t}-${o}-${a}T00:00:00Z`).toISOString()}constructor(...e){super(...e),this.data=[],this.nom="",this.prenom="",this.mail="",this.isAdmin=null}}(0,r.__decorate)([(0,n.state)()],l.prototype,"isAdmin",void 0),l=(0,r.__decorate)([(0,n.customElement)({name:"page-compte",template:(0,n.html)`${e=>(0,n.html)`
      <pf-page masterhead-no-icon masterhead-no-branding drawer-inline drawer-expanded drawer-static drawer-panel-left>
          ...
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
              ${(0,n.asyncAppend)(e.preloadData("http://www.octopusjjb.ovh/informations"),t=>(0,n.html)`${(0,n.repeat)(t,(0,n.html)`${t=>(console.log(t),(0,n.html)`
                          <div class="row">
...
#dropdownMenu.visible {
  ...
  /* Autres styles pour le menu visible, comme une animation */
    ...
    `]})],l);let i=(0,n.html)`${e=>(0,n.html)`<page-compte></page-compte>`}`;(0,n.render)(i);
//# sourceMappingURL=index.43de77ff.js.map
