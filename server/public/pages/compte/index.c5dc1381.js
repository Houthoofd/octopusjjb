                          ...
                          <div class="row">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  ${(0,n.asyncAppend)(e.preloadDataDropDown("http://localhost:3000/informations/grade"),t=>(console.log(t),(0,n.html)`${(0,n.repeat)(t,(0,n.html)`${t=>(console.log(t),(0,n.html)`<div class="dropdown-item" data-grade="${t.grade}"@click="${t=>e.handleDropDownValueGrade(t)}">
                                         ${t.grade}
                                        </div>`)}`)}`))}
                                </div>
                              </details>
...
//# sourceMappingURL=index.c5dc1381.js.map
