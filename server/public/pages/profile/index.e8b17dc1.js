          ...
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
              ${(0,l.asyncAppend)(e.preloadData(),r=>(console.log(r),(0,l.html)`
                    ...
                    ${(0,l.repeat)(r.totalCourses,(0,l.html)`${r=>(console.log(r.month,r.total_courses),(0,l.html)`
                          <div class="row">
...
//# sourceMappingURL=index.e8b17dc1.js.map
