var e=globalThis,t={},r={},a=e.parcelRequirec605;null==a&&((a=function(e){if(e in t)return t[e].exports;if(e in r){var a=r[e];delete r[e];var o={id:e,exports:{}};return t[e]=o,a.call(o.exports,o,o.exports),o.exports}var l=Error("Cannot find module '"+e+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(e,t){r[e]=t},e.parcelRequirec605=a),a.register;var o=a("7WQrb"),l=a("5D1XK");a("RKbfs"),a("5OQrz"),a("2LYUy"),a("7KTRf");class s extends l.WebComponent{async preloadData(){try{let e=localStorage.getItem("userData");if(!e)throw Error("Utilisateur non connecté. Aucune donnée dans localStorage.");let t=JSON.parse(e);console.log("Données utilisateur récupérées:",t);let r=await fetch("http://localhost:3000/profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!r.ok)throw Error("Erreur serveur.");let a=await r.json();return a.totalCourses.length>0?a:[]}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}calculatePresenceRate(e,t){let r=e.length,a=e.filter(e=>1===e.status).length;return(console.log(r,a,t),0===t||0===r)?"0%":`${(a/(t*r)*100).toFixed(2)}%`}formatDateFromISO(e){let t=new Date(e),r=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return`${r}-${a}-${o}`}convertToISODate(e){let[t,r,a]=e.split("-");return new Date(`${t}-${r}-${a}T00:00:00Z`).toISOString()}constructor(...e){super(...e),this.data=[]}}s=(0,o.__decorate)([(0,l.customElement)({name:"page-profile",template:(0,l.html)`${e=>(0,l.html)`
          ...
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
              ${(0,l.asyncAppend)(e.preloadData(),t=>(console.log(t),(0,l.html)`
                    ...
                    ${(0,l.repeat)(t.totalCourses,(0,l.html)`${t=>(console.log(t.month,t.total_courses),(0,l.html)`
                          <div class="row">
    ...
    `]})],s);let n=(0,l.html)`${e=>(0,l.html)`<page-profile></page-profile>`}`;(0,l.render)(n);
//# sourceMappingURL=index.2d436349.js.map
