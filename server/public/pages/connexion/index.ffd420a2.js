var e=globalThis,o={},r={},t=e.parcelRequirec605;null==t&&((t=function(e){if(e in o)return o[e].exports;if(e in r){var t=r[e];delete r[e];var n={id:e,exports:{}};return o[e]=n,t.call(n.exports,n,n.exports),n.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,o){r[e]=o},e.parcelRequirec605=t),t.register;var n=t("5D1XK");t("RKbfs"),t("5OQrz"),t("2LYUy");var a=t("7WQrb"),n=t("5D1XK");t("RKbfs"),t("5OQrz"),t("2LYUy");class l extends n.WebComponent{}l=(0,a.__decorate)([(0,n.customElement)({name:"login-page",template:(0,n.html)`${e=>(0,n.html)`
  ...
  border-radius: 0;  /* Pas d'arrondis, donc un carré */
  background-color: #fff;
  cursor: pointer;
}

input[type="radio"]:checked {
  background-color: #000; /* Remplit le carré lorsqu'il est sélectionné */
}
      label{
        color: #a2adbe;
      }
    ...
    `],shadowOptions:{mode:"open"}})],l);let i=(0,n.html)`${e=>(0,n.html)`<login-page>
    <h3>Hello</h3>
...
//# sourceMappingURL=index.ffd420a2.js.map
