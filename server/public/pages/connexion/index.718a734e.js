var e=globalThis,i={},o={},a=e.parcelRequirec605;null==a&&((a=function(e){if(e in i)return i[e].exports;if(e in o){var a=o[e];delete o[e];var l={id:e,exports:{}};return i[e]=l,a.call(l.exports,l,l.exports),l.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,i){o[e]=i},e.parcelRequirec605=a),a.register;var l=a("5D1XK");a("RKbfs"),a("5OQrz"),a("2LYUy");var n=a("7WQrb"),l=a("5D1XK");a("RKbfs"),a("5OQrz"),a("2LYUy");class t extends l.WebComponent{}t=(0,n.__decorate)([(0,l.customElement)({name:"login-page",template:(0,l.html)`${e=>(0,l.html)`
        <div
...
<div class="pf-v5-c-login">
  <div class="pf-v5-c-login__container">
    ...
    <footer class="pf-v5-c-login__footer">
      ...
      `}`,styles:[(0,l.css)`${String({brand:"pf-v5-c-brand",button:"pf-v5-c-button",dropdown:"pf-v5-c-dropdown",list:"pf-v5-c-list",login:"pf-v5-c-login",loginContainer:"pf-v5-c-login__container",loginFooter:"pf-v5-c-login__footer",loginHeader:"pf-v5-c-login__header",loginMain:"pf-v5-c-login__main",loginMainBody:"pf-v5-c-login__main-body",loginMainFooter:"pf-v5-c-login__main-footer",loginMainFooterBand:"pf-v5-c-login__main-footer-band",loginMainFooterLinks:"pf-v5-c-login__main-footer-links",loginMainFooterLinksItem:"pf-v5-c-login__main-footer-links-item",loginMainFooterLinksItemLink:"pf-v5-c-login__main-footer-links-item-link",loginMainHeader:"pf-v5-c-login__main-header",loginMainHeaderDesc:"pf-v5-c-login__main-header-desc",loginMainHeaderUtilities:"pf-v5-c-login__main-header-utilities",themeDark:"pf-v5-theme-dark",title:"pf-v5-c-title"})}`],shadowOptions:{mode:"open"}})],t);let r=(0,l.html)`${e=>(0,l.html)`<login-page>
    <h3>Hello</h3>
  </login-page>`}`;document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector("form"),i=document.createElement("div");e?.appendChild(i),e&&e.addEventListener("submit",e=>{e.preventDefault();let o=document.querySelectorAll("input"),a=o[0].value,l=o[1].value;if(!a||!l){i.textContent="Veuillez remplir tous les champs.";return}let n={email:a,password:l};console.log(n),fetch("http://localhost:3000/connexion/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)}).then(e=>{if(!e.ok)throw Error("Erreur serveur.");return e.json()}).then(e=>{if(e.length>0){for(let i of e)localStorage.setItem("first_name",i.first_name),localStorage.setItem("email",i.email),localStorage.setItem("role",i.status),localStorage.setItem("isLogged","true"),console.log("mise en mémoire dans le locale storage"+i.first_name+i.email);window.location.href="http://localhost:1234"}else i.textContent="Utilisateur non trouvé ou mot de passe incorrect.";console.log("Réponse du serveur:",e)}).catch(e=>{i.innerHTML="Vous n'êtes pas encore inscris, veuillez vous <a href='inscriptions'><strong>inscrire</string></a>",console.error("Erreur lors de la requête fetch:",e)})})}),(0,l.render)(r);
//# sourceMappingURL=index.718a734e.js.map
