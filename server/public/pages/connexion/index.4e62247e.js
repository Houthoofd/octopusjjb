var e=globalThis,a={},l={},i=e.parcelRequirec605;null==i&&((i=function(e){if(e in a)return a[e].exports;if(e in l){var i=l[e];delete l[e];var o={id:e,exports:{}};return a[e]=o,i.call(o.exports,o,o.exports),o.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,a){l[e]=a},e.parcelRequirec605=i),i.register;var o=i("5D1XK");i("RKbfs"),i("5OQrz"),i("2LYUy");var s=i("7WQrb"),o=i("5D1XK");i("RKbfs"),i("5OQrz"),i("2LYUy");class r extends o.WebComponent{}r=(0,s.__decorate)([(0,o.customElement)({name:"login-page",template:(0,o.html)`${e=>(0,o.html)`
        <div
...
<div class="pf-v5-c-login">
  <div class="pf-v5-c-login__container">
    ...
    `],shadowOptions:{mode:"open"}})],r);let t=(0,o.html)`${e=>(0,o.html)`<login-page>
    <h3>Hello</h3>
  </login-page>`}`;document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector("form"),a=document.createElement("div");e?.appendChild(a),e&&e.addEventListener("submit",e=>{e.preventDefault();let l=document.querySelectorAll("input"),i=l[0].value,o=l[1].value;if(!i||!o){a.textContent="Veuillez remplir tous les champs.";return}let s={email:i,password:o};console.log(s),fetch("http://localhost:3000/connexion/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)}).then(e=>{if(!e.ok)throw Error("Erreur serveur.");return e.json()}).then(e=>{if(e.length>0){for(let a of e)localStorage.setItem("first_name",a.first_name),localStorage.setItem("email",a.email),localStorage.setItem("role",a.status),localStorage.setItem("isLogged","true"),console.log("mise en mémoire dans le locale storage"+a.first_name+a.email);window.location.href="http://localhost:1234"}else a.textContent="Utilisateur non trouvé ou mot de passe incorrect.";console.log("Réponse du serveur:",e)}).catch(e=>{a.innerHTML="Vous n'êtes pas encore inscris, veuillez vous <a href='inscriptions'><strong>inscrire</string></a>",console.error("Erreur lors de la requête fetch:",e)})})}),(0,o.render)(t);
//# sourceMappingURL=index.4e62247e.js.map
