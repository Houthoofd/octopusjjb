var e=globalThis,i={},a={},t=e.parcelRequirec605;null==t&&((t=function(e){if(e in i)return i[e].exports;if(e in a){var t=a[e];delete a[e];var o={id:e,exports:{}};return i[e]=o,t.call(o.exports,o,o.exports),o.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,i){a[e]=i},e.parcelRequirec605=t),t.register;var o=t("7WQrb"),s=t("5D1XK");t("RKbfs"),t("5OQrz"),t("2LYUy");class r extends s.WebComponent{}r=(0,o.__decorate)([(0,s.customElement)({name:"page-informations",template:(0,s.html)`${e=>(0,s.html)`<pf-page masterhead-no-icon masterhead-no-branding drawer-inline drawer-expanded drawer-static drawer-panel-left >
    ...
    <pf-avatar></pf-avatar>
  </pf-page>`}`})],r);let l=(0,s.html)`${e=>(0,s.html)`<page-informations></page-informations>`}`;(0,s.render)(l);
//# sourceMappingURL=index.92407be6.js.map
