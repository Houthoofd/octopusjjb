var e=globalThis,t={},a={},o=e.parcelRequirec605;null==o&&((o=function(e){if(e in t)return t[e].exports;if(e in a){var o=a[e];delete a[e];var n={id:e,exports:{}};return t[e]=n,o.call(n.exports,n,n.exports),n.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){a[e]=t},e.parcelRequirec605=o),o.register;var n=o("7WQrb"),i=o("5D1XK");o("RKbfs"),o("5OQrz"),o("2LYUy");class r extends i.WebComponent{async connectedCallback(){super.connectedCallback();try{let e=await this.preloadData();console.log(e.length),e.length>0&&(console.log("Nouvelles données reçues :",e),this.data=[...e],console.log("Données assignées à this.data :",this.data))}catch(e){console.error("Erreur lors de la récupération et l'assignation des données:",e)}}async preloadData(){try{let e=localStorage.getItem("userData");if(!e)throw Error("Utilisateur non connecté. Aucune donnée dans localStorage.");let t=JSON.parse(e);console.log("Données utilisateur:",t);let a=await fetch("http://localhost:3000/informations",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!a.ok)throw Error("Erreur serveur.");let o=await a.json();return console.log("Données reçues de l'API:",o),o.length>0?o:[]}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}constructor(...e){super(...e),this.data=[]}}r=(0,n.__decorate)([(0,i.customElement)({name:"page-informations",template:(0,i.html)`${e=>(0,i.html)`
...
//# sourceMappingURL=index.d2a3e081.js.map
