        ...
        <div>
          <pf-panel header scrollable>
            ...
            <div class="table-infos">
              ${(0,r.asyncAppend)(e.preloadData(),t=>(console.log(e.data),(0,r.html)`${(0,r.repeat)(t,(0,r.html)`${e=>(console.log(e),(0,r.html)`
                          <div class="row">
...
//# sourceMappingURL=index.898317e5.js.map
