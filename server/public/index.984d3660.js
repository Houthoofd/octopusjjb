var e=globalThis,t={},i={},o=e.parcelRequirec605;function s(e,t,i,o){var s,a=arguments.length,n=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var l=e.length-1;l>=0;l--)(s=e[l])&&(n=(a<3?s(n):a>3?s(t,i,n):s(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n}null==o&&((o=function(e){if(e in t)return t[e].exports;if(e in i){var o=i[e];delete i[e];var s={id:e,exports:{}};return t[e]=s,o.call(s.exports,s,s.exports),s.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){i[e]=t},e.parcelRequirec605=o),o.register,"function"==typeof SuppressedError&&SuppressedError;var a=o("1BF7I"),n=o("5OQrz");o("lTDtW"),o("2LYUy");class l extends a.WebComponent{}l=s([(0,a.customElement)({name:"main-home",template:(0,a.html)`${e=>(0,a.html)`<div>
        ...
        `],shadowOptions:{mode:"open"}})],l);class r extends a.WebComponent{}r=s([(0,a.customElement)({name:"main-section",template:(0,a.html)`${e=>(0,a.html)`<section>
            <slot></slot>
    </section>`}`})],r);class c extends a.WebComponent{}c=s([(0,a.customElement)({name:"main-footer",template:(0,a.html)`${e=>(0,a.html)`<footer>
            <slot></slot>
    </footer>`}`})],c);class d extends n.PfModalBox{}d=s([(0,a.customElement)({name:"custom-modal"})],d),(0,a.render)((0,a.html)`<main-home></main-home>`,document.body);
//# sourceMappingURL=index.984d3660.js.map
