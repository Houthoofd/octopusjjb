var i=globalThis,s={},e={},t=i.parcelRequirec605;function a(i,s,e,t){var a,o=arguments.length,l=o<3?s:null===t?t=Object.getOwnPropertyDescriptor(s,e):t;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(i,s,e,t);else for(var n=i.length-1;n>=0;n--)(a=i[n])&&(l=(o<3?a(l):o>3?a(s,e,l):a(s,e))||l);return o>3&&l&&Object.defineProperty(s,e,l),l}null==t&&((t=function(i){if(i in s)return s[i].exports;if(i in e){var t=e[i];delete e[i];var a={id:i,exports:{}};return s[i]=a,t.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+i+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(i,s){e[i]=s},i.parcelRequirec605=t),t.register,"function"==typeof SuppressedError&&SuppressedError;var o=t("1BF7I"),l=t("5OQrz");t("lTDtW"),t("2LYUy");class n extends o.WebComponent{}n=a([(0,o.customElement)({name:"main-home",template:(0,o.html)`${i=>(0,o.html)`<div>
        ...
        `],shadowOptions:{mode:"open"}})],n);class r extends o.WebComponent{}r=a([(0,o.customElement)({name:"main-section",template:(0,o.html)`${i=>(0,o.html)`<section>
            <slot></slot>
    </section>`}`})],r);class c extends o.WebComponent{}c=a([(0,o.customElement)({name:"main-footer",template:(0,o.html)`${i=>(0,o.html)`<footer>
            <slot></slot>
...
//# sourceMappingURL=index.f4cfd0fa.js.map
