var e=globalThis,i={},s={},t=e.parcelRequirec605;null==t&&((t=function(e){if(e in i)return i[e].exports;if(e in s){var t=s[e];delete s[e];var a={id:e,exports:{}};return i[e]=a,t.call(a.exports,a,a.exports),a.exports}var l=Error("Cannot find module '"+e+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(e,i){s[e]=i},e.parcelRequirec605=t),t.register;var a=t("1BF7I");t("lTDtW"),t("5OQrz"),t("2LYUy");let l=(0,a.html)`${e=>(e.createConsumable("selection",[]),localStorage.getItem("first_name")&&console.log(localStorage.getItem("first_name")||""),(0,a.html)`<div class='home'>
        ...
        <div class="date">${c(e.date_cours)}</div>
        <div class="heure-debut">${e.heure_debut}</div>
        <div class="heure-fin">${e.heure_fin}</div>
        <div class="delete" @click=${()=>o(e)}><pf-icons-trash-alt></pf-icons-trash-alt></div>
    `;i?(r.push({cour:e.type_cours,date:c(e.date_cours),heure_debut:e.heure_debut,heure_fin:e.heure_fin}),localStorage.setItem("selectionArray",JSON.stringify(r)),console.log(r),(0,a.render)(s,i)):console.error("Élément .selection introuvable")})(e)}>
                                                        <div class="type-de-cours">${e.type_cours}</div>
                                                        <div class="date">${c(e.date_cours)}</div>
                                                        <div class="heure-debut">${e.heure_debut}</div>
                                                        <div class="heure-fin">${e.heure_fin}</div>
                    ...
                    <div name="extra-slot">
                        <div class="selection" ${function(){let e=document.querySelectorAll(".selection")[0],i=localStorage.getItem("selectionArray");if(i){let s=JSON.parse(i);e.innerHTML="",s.forEach(i=>{let s=(0,a.html)`
                <div class="type-de-cours">${i.type_cours}</div>
                <div class="date">${c(i.date_cours)}</div>
                <div class="heure-debut">${i.heure_debut}</div>
                <div class="heure-fin">${i.heure_fin}</div>
                <div class="delete" @click=${()=>o(i)}><pf-icons-trash-alt></pf-icons-trash-alt></div>
            `;(0,a.render)(s,e)})}else console.log("Aucune sélection trouvée dans le local storage.")}()}></div>
                    </div>
                </pf-modal>
    ...
    </div>`)}`,r=JSON.parse(localStorage.getItem("selectionArray")||"[]");function o(e){r=r.filter(i=>i.cour!==e.type_cours||i.date!==c(e.date_cours)),localStorage.setItem("selectionArray",JSON.stringify(r)),console.log(r);let i=document.querySelector(".selection");i&&(i.innerHTML="")}const n=new Promise((e,i)=>{fetch("http://localhost:3000/cours/",{method:"GET",headers:{"Content-Type":"application/json"}}).then(e=>{if(!e.ok)throw i("Erreur serveur."),Error("Erreur serveur.");return e.json()}).then(i=>{i.length>0?(console.log("Réponse du serveur:",i),e(i)):e([])}).catch(e=>{console.error("Erreur lors de la requête fetch:",e),i(e)})});function c(e){let i=new Date(e),s=i.getFullYear(),t=String(i.getMonth()+1).padStart(2,"0"),a=String(i.getDate()).padStart(2,"0");return`${s}-${t}-${a}`}(0,a.render)(l);
//# sourceMappingURL=index.ee170d0b.js.map
