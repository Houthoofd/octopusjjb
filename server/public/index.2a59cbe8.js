                    ...
                    <slot>
                        <div class="table-infos">
                            ${(0,a.asyncAppend)(r,i=>(0,a.html)`
                                <div class="raw-infos">
                                        ${(0,a.repeat)(i,(0,a.html)`${i=>(0,a.html)`<div class="row" @click=${i=>{console.log(o(i.date_cours)),console.log(document.querySelectorAll(".selection")[0])}}>
...
//# sourceMappingURL=index.2a59cbe8.js.map
