var i=globalThis,s={},e={},a=i.parcelRequirec605;null==a&&((a=function(i){if(i in s)return s[i].exports;if(i in e){var a=e[i];delete e[i];var t={id:i,exports:{}};return s[i]=t,a.call(t.exports,t,t.exports),t.exports}var r=Error("Cannot find module '"+i+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(i,s){e[i]=s},i.parcelRequirec605=a),a.register;var t=a("1BF7I");a("lTDtW"),a("5OQrz"),a("2LYUy");let r=(0,t.html)`${i=>(i.createConsumable("selection",[]),localStorage.getItem("first_name")&&console.log(localStorage.getItem("first_name")||""),(0,t.html)`<div class='home'>
        ...
        <section id="réservation">
            ...
            <form>
                ...
                <pf-modal class='result-box' scrollable medium>
                    ...
                    <slot>
                        <div>
                            ${(0,t.asyncAppend)(l,i=>(console.log(i),(0,t.html)`
                                <div class="raw-infos">
                                    <p>Cours trouvés : ${i.length}</p>
                                    <div class="row">
                                        ${(0,t.repeat)(i,(0,t.html)`${i=>(0,t.html)`
                                                        <div>Type de cours:</strong> ${i.type_cours}</div>
                                                        <div>Date:</div>
                                                        <div>Heure de début: ${i.heure_debut}</div>
                                                        <div>Heure de fin: ${i.heure_fin}</div>
                                                    `}`)}
                                    </div>
                                </div>
                                `))}
    ...
    </div>`)}`;const l=new Promise((i,s)=>{fetch("http://localhost:3000/cours/",{method:"GET",headers:{"Content-Type":"application/json"}}).then(i=>{if(!i.ok)throw s("Erreur serveur."),Error("Erreur serveur.");return i.json()}).then(s=>{s.length>0?(console.log("Réponse du serveur:",s),i(s)):i([])}).catch(i=>{console.error("Erreur lors de la requête fetch:",i),s(i)})});(0,t.render)(r);
//# sourceMappingURL=index.67ae3f52.js.map
