                ...
                <pf-modal class='result-box' scrollable medium>
                    ...
                    <slot>
                        <div class="table-infos">
                            ${(0,t.asyncAppend)(r,i=>(console.log(i),(0,t.html)`
                                <div class="raw-infos">
                                        ${(0,t.repeat)(i,(0,t.html)`${i=>(0,t.html)`<div class="row">
                                                        <div class="type-de-cours">Type de cours:</strong> ${i.type_cours}</div>
                                                        <div class="date">Date:</div>
                                                        <div class="heure-debut">Heure de début: ${i.heure_debut}</div>
                                                        <div class="heure-fin">Heure de fin: ${i.heure_fin}</div>
                                                    </div>`}`)}
                                    </div>
                                </div>
                                `))}
