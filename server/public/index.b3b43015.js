var e=globalThis,t={},i={},o=e.parcelRequirec605;function a(e,t,i,o){var a,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var r=e.length-1;r>=0;r--)(a=e[r])&&(n=(s<3?a(n):s>3?a(t,i,n):a(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n}null==o&&((o=function(e){if(e in t)return t[e].exports;if(e in i){var o=i[e];delete i[e];var a={id:e,exports:{}};return t[e]=a,o.call(a.exports,a,a.exports),a.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){i[e]=t},e.parcelRequirec605=o),o.register,"function"==typeof SuppressedError&&SuppressedError;var s=o("1BF7I"),n=o("5OQrz");o("lTDtW"),o("2LYUy");class r extends s.WebComponent{}r=a([(0,s.customElement)({name:"main-home",template:(0,s.html)`${e=>(0,s.html)`<div>
        ...
        `],shadowOptions:{mode:"open"}})],r);class l extends s.WebComponent{attributeChangedCallback(e,t,i){"visible"===e&&(this.isVisible="true"===i),super.attributeChangedCallback(e,t,i)}displayForm(){this.isVisible=!this.isVisible,this.visible=this.isVisible?"true":"false"}async getValues(){let e=this.shadowRoot?.querySelectorAll("input");this.shadowRoot?.querySelectorAll(".available")[0];let t=e?.[0].value||"",i=e?.[1].value||"";t&&i?this.selection.push({nom:t,email:i}):alert("Vous devez remplir les champs")}async connectedCallback(){super.connectedCallback();try{this.cours=await this.preloadData(),console.log("Réponse du serveur:",this.cours)}catch(e){console.error("Erreur lors de la récupération des données:",e)}}async preloadData(){try{let e=await fetch("http://localhost:3000/cours/",{method:"GET",headers:{"Content-Type":"application/json"}});if(!e.ok)throw Error("Erreur serveur.");let t=await e.json();return t.length>0?t:[]}catch(e){return console.error("Erreur lors de la requête fetch:",e),[]}}constructor(...e){super(...e),this.selection=[],this.cours=[],this.visible=null,this.isVisible=!1}}a([s.attr],l.prototype,"visible",void 0),a([(0,s.state)()],l.prototype,"isVisible",void 0),l=a([(0,s.customElement)({name:"special-section",template:(0,s.html)`${e=>(0,s.html)`
            ...
            ${e.isVisible?(0,s.html)`
                <form>
                    ...
                    <pf-panel>
                        ...
                        <slot>
                            <div class="available" 
                            ${(0,s.repeat)(e.cours,(0,s.html)`${t=>(console.log(e.cours),(0,s.html)`
                                            <div class="row">
                                                <div class="date">${t.date_cours}</div>
        ...
        `]})],l);class c extends s.WebComponent{}c=a([(0,s.customElement)({name:"main-footer",template:(0,s.html)`${e=>(0,s.html)`
            <footer>
        ...
        `]})],c);class d extends n.PfModalBox{}d=a([(0,s.customElement)({name:"custom-modal"})],d),(0,s.render)((0,s.html)`<main-home></main-home>`,document.body);
//# sourceMappingURL=index.b3b43015.js.map
