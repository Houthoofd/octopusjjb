                    ...
                    <slot>
                        <div class="table-infos">
                            ${(0,a.asyncAppend)(r,i=>(0,a.html)`
                                <div class="raw-infos">
                                        ${(0,a.repeat)(i,(0,a.html)`${i=>(0,a.html)`<div class="row" @click=${i=>(function(i){console.log(o(i.date_cours));let e=document.querySelectorAll("pf-modal")[0],s=document.querySelectorAll(".selection")[0];s.innerHTML=i,e.appendChild(s)})(i)}>
...
//# sourceMappingURL=index.350fd7bf.js.map
