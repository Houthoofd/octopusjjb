                    ...
                    <slot>
                        <div class="table-infos">
                            ${(0,a.asyncAppend)(r,i=>(console.log(i),(0,a.html)`
                                <div class="raw-infos">
                                        ${(0,a.repeat)(i,(0,a.html)`${i=>{let e=function(i){let e=new Date(i),s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0");return`${s}-${t}-${a}`}(i.date);return(0,a.html)`<div class="row">
...
//# sourceMappingURL=index.8fe15d70.js.map
