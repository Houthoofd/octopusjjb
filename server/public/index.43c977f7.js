var e=globalThis,t={},s={},i=e.parcelRequirec605;null==i&&((i=function(e){if(e in t)return t[e].exports;if(e in s){var i=s[e];delete s[e];var o={id:e,exports:{}};return t[e]=o,i.call(o.exports,o,o.exports),o.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){s[e]=t},e.parcelRequirec605=i),i.register;var o=i("1BF7I");i("lTDtW"),i("5OQrz"),i("2LYUy");let a=(0,o.html)`${e=>(e.createConsumable("selection",[]),localStorage.getItem("first_name")&&console.log(localStorage.getItem("first_name")||""),(0,o.html)`<div class='home'>
        ...
        <section id="réservation">
            ...
            <span>Ne manquer pas cette occasion d'esseyer un cours gratuit</span>
                <div>
                    ${(0,o.asyncAppend)(l,e=>{for(let t of e)console.log(t.type_cours);return(0,o.html)`
                        <div>
                            <p>Cours trouvés : ${e.length}</p>
                            <ul>
                                ${(0,o.repeat)(e,e=>(0,o.html)`
                                    <li>
...
//# sourceMappingURL=index.43c977f7.js.map
