var i=globalThis,s={},e={},t=i.parcelRequirec605;null==t&&((t=function(i){if(i in s)return s[i].exports;if(i in e){var t=e[i];delete e[i];var a={id:i,exports:{}};return s[i]=a,t.call(a.exports,a,a.exports),a.exports}var n=Error("Cannot find module '"+i+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(i,s){e[i]=s},i.parcelRequirec605=t),t.register;var a=t("1BF7I");t("lTDtW"),t("5OQrz"),t("2LYUy");let n=(0,a.html)`${i=>(localStorage.getItem("first_name")&&console.log(localStorage.getItem("first_name")||""),(0,a.html)`<div class='home'>
...
//# sourceMappingURL=index.6fb1a27d.js.map
