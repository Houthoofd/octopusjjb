                    ...
                    <slot>
                        <div class="table-infos">
                            ${(0,a.asyncAppend)(r,i=>(0,a.html)`
                                <div class="raw-infos">
                                        ${(0,a.repeat)(i,(0,a.html)`${i=>(0,a.html)`<div class="row" @click=${i=>{console.log(o(i.date_cours)),document.querySelectorAll("pf-modal")[0].querySelector('[slot="extra-slot"]')}}>
...
//# sourceMappingURL=index.200d20ad.js.map
