                    ...
                    <slot>
                        <div class="table-infos">
                            ${(0,a.asyncAppend)(r,i=>(0,a.html)`
                                <div class="raw-infos">
                                        ${(0,a.repeat)(i,(0,a.html)`${i=>(0,a.html)`<div class="row" @click=${i=>{console.log(i.date_cours)}}>
                                                        <div class="type-de-cours">${i.type_cours}</div>
                                                        <div class="date">${(function(i){let s=new Date(i),e=s.getFullYear(),t=String(s.getMonth()+1).padStart(2,"0"),a=String(s.getDate()).padStart(2,"0");return`${e}-${t}-${a}`})(i.date_cours)}</div>
...
//# sourceMappingURL=index.6931832a.js.map
