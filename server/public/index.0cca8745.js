var e=globalThis,s={},t={},i=e.parcelRequirec605;null==i&&((i=function(e){if(e in s)return s[e].exports;if(e in t){var i=t[e];delete t[e];var a={id:e,exports:{}};return s[e]=a,i.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,s){t[e]=s},e.parcelRequirec605=i),i.register;var a=i("1BF7I");i("lTDtW"),i("5OQrz"),i("2LYUy");let o=(0,a.html)`${e=>(e.createConsumable("selection",[]),localStorage.getItem("first_name")&&console.log(localStorage.getItem("first_name")||""),(0,a.html)`<div class='home'>
        ...
        <section id="réservation">
            ...
            <span>Ne manquer pas cette occasion d'esseyer un cours gratuit</span>
                <div>
                    ${(0,a.asyncAppend)(l,e=>{for(let s of e)console.log(s.type_cours);return(0,a.html)`
                        <div>
                            <p>Cours trouvés : ${e.length}</p>
                            <ul>
                                ${(0,a.repeat)(e,e=>(0,a.html)`
                                    <li>
                                        <p><strong>Type de cours:</strong> ${e}</p>
                                        <p><strong>Date:</strong> ${new Date(e).toLocaleDateString()}</p>
                                        <p><strong>Heure de début:</strong> ${e}</p>
                                        <p><strong>Heure de fin:</strong> ${e}</p>
                                    </li>
                                `)}
                            </ul>
                        </div>
...
//# sourceMappingURL=index.0cca8745.js.map
