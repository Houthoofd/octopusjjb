...
},{"express":"express","./connexion":"60fcK","./cours":"a6APd","./inscriptions":"4x4tx","./reservations":"l5JrX","./profile":"g6BAY","./compte":"59CY8","./infos":"lq7bg","./new-password":"hhwxc","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"60fcK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _express = require("express");
var _expressDefault = parcelHelpers.interopDefault(_express);
...
router.post("/", async (req, res)=>{
    ...
    try {
        ...
        const match = await (0, _bcryptDefault.default).compare(password, password);
        if (match) // Le mot de passe est correct
        console.log("Connexion r\xe9ussie !");
        else // Le mot de passe est incorrect
        console.log("\xc9chec de la connexion !");
        ...
        console.log("Utilisateur connect\xe9 :", userData);
        res.status(200).json({
...
},{"express":"express","bcrypt":"bcrypt","../packages/db/client":"lxff2","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"lxff2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
router.post("/participant/cancel", async (req, res)=>{
    ...
    `;
        ...
        if (result.length === 0) return res.status(404).json({
            success: false,
            message: "Participant non trouv\xe9."
        });
    ...
    `;
        ...
        res.status(200).json({
            success: true,
            message: "Pr\xe9sence annul\xe9e avec succ\xe8s."
        });
    } catch (error) {
...
},{"express":"express","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"59CY8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _express = require("express");
var _expressDefault = parcelHelpers.interopDefault(_express);
...
},{"express":"express","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}]},["2yv2t","lLvi7"], "lLvi7", "parcelRequirec605")
