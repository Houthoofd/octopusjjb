...
app.use((0, _corsDefault.default)(corsOptions));
...
router.post("/participant", async (req, res)=>{
    ...
    `;
        ...
        const participants = await client.query(query, [
            cour_id
        ]);
        // Vérifier s'il y a des participants
        if (participants.length === 0) return res.status(404).json({
        ...
        res.status(200).send({
            ...
            message: "Participants trouv\xe9s"
        });
    } catch (error) {
...
router.post("/inscription", async (req, res)=>{
    ...
    if (!nom || !prenom || !email || !coursId) return res.status(400).json({
...
router.post("/", async (req, res)=>{
    ...
    if (!firstName || !lastName || !email || !password || !date) return res.status(400).send("Tous les champs sont requis");
    const client = new (0, _client.Client)();
    try {
        ...
        res.status(201).send("Utilisateur enregistr\xe9 avec succ\xe8s");
    } catch (error) {
        console.error("Erreur lors de l'inscription", error);
...
},{"express":"express","jsonwebtoken":"jsonwebtoken","../packages/db/client":"lxff2","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"59CY8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _express = require("express");
var _expressDefault = parcelHelpers.interopDefault(_express);
...
},{"express":"express","jsonwebtoken":"jsonwebtoken","../packages/db/client":"lxff2","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"lq7bg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _express = require("express");
var _expressDefault = parcelHelpers.interopDefault(_express);
...
router.post("/", verifyToken, async (req, res)=>{
    ...
    if (!email || !prenom || !nom) return res.status(400).send("Tous les champs sont requis.");
    const client = new (0, _client.Client)();
    try {
...
},{"express":"express","jsonwebtoken":"jsonwebtoken","../packages/db/client":"lxff2","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"hhwxc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _express = require("express");
var _expressDefault = parcelHelpers.interopDefault(_express);
...
},{"express":"express","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"7oh3P":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _express = require("express");
var _expressDefault = parcelHelpers.interopDefault(_express);
...
router.post("/infos", async (req, res)=>{
    ...
    try {
        ...
        console.error("Erreur lors de la r\xe9cup\xe9ration des informations de l'utilisateur :", err);
        return res.status(500).send("Erreur lors de la r\xe9cup\xe9ration des informations.");
    }
});
exports.default = router;

},{"express":"express","jsonwebtoken":"jsonwebtoken","../packages/db/client":"lxff2","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}]},["2yv2t","lLvi7"], "lLvi7", "parcelRequirec605")
